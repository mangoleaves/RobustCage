...
/// @brief seg: p1->p2, query point: p3
/// @return 1: p3 on the left of p1p2, 0: exactly on, -1: right.
...
/// @brief ad = q-p, bd = r-p, cd = s-p
/// @return det = dot(ad, cross(bd, cd)), 0 -> coplanar, 1 -> positive volume, -1 -> negtive volume.
...
///@brief query point:q, plane:p r s
